-- ============================================================
-- 17 — LA GALLERIA DELLE FOTO
--
-- Chiesto da Luka il 22 settembre 2026: le foto dell'ultima serata,
-- che tutti vogliono vedere, diventano il motivo per iscriversi.
--
-- Decisioni prese:
--   · le foto le vedono SOLO gli iscritti, sempre (non 24h e poi
--     pubbliche come prevedeva il piano di luglio)
--   · il download in alta qualità è per gli iscritti
--   · i file stanno su Cloudflare R2, non qui: qui c'è solo l'elenco
--     di cosa esiste e chi può vederlo
--
-- Il controllo di chi vede cosa NON è nel browser: il sito chiede al
-- server una foto per volta, e il server risponde solo a chi ha un
-- profilo. Senza account non si arriva ai file, nemmeno indovinando
-- l'indirizzo.
--
